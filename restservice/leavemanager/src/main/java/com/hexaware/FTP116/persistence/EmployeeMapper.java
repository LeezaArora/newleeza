...
public class EmployeeMapper implements ResultSetMapper<Employee> {
  ...
  public final Employee map(final int idx, final ResultSet rs, final StatementContext ctx) throws SQLException {
     ...
     * @return Employee
     */
    // return new Employee(rs.getInt("EMP_ID"), rs.getString("EMP_FULL_NAME"),rs.getString("EMP_MOBILE_NO") ,
    //                     rs.getDate("EMP_DATE_OF_JOINING"), rs.getInt("EMP_MGR_ID"), rs.getString("EMP_EMAIL_ID") ,
    //                     rs.getInt("balanceEl"), rs.getInt("balancePl"), rs.getInt("balanceMl"),
    //                     rs.getString("EMP_DEPARTMENT"));
                         ...
                         rs.getInt("EMP_DEPARTMENT"), rs.getInt("EMP_LEAVE_BALANCE"),
                         rs.getInt("El"), rs.getInt("Pl"),
                         rs.getString("EMP_MGR_ID"));
  }
}
