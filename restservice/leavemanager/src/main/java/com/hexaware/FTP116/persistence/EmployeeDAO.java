...
public interface EmployeeDAO  {
 ...
 /*  
  ...
  void increment(@Bind("empID") int empID,
                @Bind("updBal") int updBal);
                */
   @SqlUpdate("UPDATE EMPLOYEDETAILS SET balanceEL = :updBal WHERE EMP_ID = :empID")
  void updateEl(@Bind("empID") int empID,
                @Bind("updBal") int updBal);
            
   @SqlUpdate("UPDATE EMPLOYEDETAILS SET balanceML = :updBal WHERE EMP_ID = :empID")
  void updateMl(@Bind("empID") int empID,
                @Bind("updBal") int updBal);
   @SqlUpdate("UPDATE EMPLOYEDETAILS SET balancePL = :updBal WHERE EMP_ID = :empID")
